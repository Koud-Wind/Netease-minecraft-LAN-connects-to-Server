...
**3.** 进入 `\MCLDownload\Game\.minecraft` 路径 (`1.21.8` 则是 `\netease_minecraft_neoforge`), 新建一个txt文本文档, 并重命名为 `#-#25565` , 其中 `25565` 是你**服务端开放的端口号**, 请自行修改 **(必须开启文件拓展名, 名称若是 `#-#25565.txt` 则不会生效)**
...
## 注意事项
+ `1.20.1 / 1.21 / 1.21.8` 可以免执行bat脚本, 但网易可能会更新强装模组, 以导致游戏报错或崩溃
+ `V_1_12_2 对应 1.12.2`
  `V_1_20 对应 1.20.1`
  `V_1_21 对应 1.21.0`
  `V_1_21_8 对应 1.21.8`
