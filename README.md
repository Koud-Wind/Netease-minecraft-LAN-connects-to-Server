...
**3.** 进入 `\MCLDownload\Game\.minecraft` 路径, 新建一个txt文本文档, 并重命名为以`#-#`开头后`#`结尾 `#-#25565`, 其中 `25565` 是你服务端开放的端口号, 支持自行修改 (必须开启文件拓展名, 名称若是 `#-#25565.txt` 则不会生效)
