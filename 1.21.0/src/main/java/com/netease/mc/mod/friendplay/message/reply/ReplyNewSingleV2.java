...
public class ReplyNewSingleV2 extends Reply {
    ...
    private Map<String, FeatureFlag> featureMap = new HashMap() {
        {
            put("bundle", FeatureFlags.BUNDLE);
    ...
    public static WorldDimensions createWorldDimensions(RegistryAccess p_251732_) {
        ...
        return ((WorldPreset) p_251732_.registryOrThrow(Registries.WORLD_PRESET).getHolderOrThrow(preset).value()).createWorldDimensions();
    }
    ...
    public void handler(byte gameType, byte onlineGameType, byte isCheat, boolean othercheat, byte isBuild, byte isBonus, byte worldType, byte isOnlineGame, String Seed, String save, String levelName, boolean update_1_21, boolean bundle, boolean tradeRebalance) {
        ...
        if (GameState.gameState == GameState.GameS.INIT) {
            ...
            try {
                ...
                LevelSettings worldsettings = new LevelSettings(levelName, wType, ishardcore, Difficulty.NORMAL, cheat, new GameRules(), worldData);
